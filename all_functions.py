...
def Leave_one_out(X_data, y_data, clf):
    ...
    ax.set_xticklabels(['','Normal','Pasient',''], fontsize=12);
    ax.grid()
    ax.set_title('Patients and normal persons', color='k', fontsize=20)
    ...
    ax.set_xlabel('Red is Pasient & blue is Normal', fontsize=16);
    ax.set_ylabel('Probability', fontsize=16);
